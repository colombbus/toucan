...
class InterviewSession_Controller extends Session_Controller {

    protected $dataName = "interviewSession";
    ...
    protected $templateControllerName = "InterviewTemplate_Controller";
