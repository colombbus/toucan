...
class InterviewTemplateIndicator_Controller extends TemplateIndicator_Controller {
    
    protected $dataName = "interviewTemplateIndicator";
    protected $controllerName = "interviewTemplateIndicator";
    protected $parentControllerName = "interviewTemplate";
