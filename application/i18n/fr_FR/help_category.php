...
$lang=array(
    ...
    <li><b>Catégorie récapitulative</b> : une catégorie récapitulative liste automatiquement tous les indicateurs définis dans l'évaluation</li>
    <li class='help_separator'></li>
    ...
    <li><b>Nom</b> : le nom de la catégorie</li>
    <li><b>Description</b> : un texte descriptif optionnel</li>
    <li><b>Catégorie récapitulative</b> : cochez cette case si vous souhaitez que la catégorie affiche automatiquement tous les indicateurs de l'évaluation</li>
    <li class='help_separator'></li>
    <li><b>Appliquer le même contrôle d'accès que pour l'évaluation</b> : si la case est cochée, la catégorie est consultable par tous les utilisateurs qui peuvent consulter l'évaluation et est modifiable par tous ceux qui peuvent modifier l'évaluation</li>
    <li><b>Consultable par</b> : l'utilisateur ou l'ensemble des utilisateurs pouvant voir cette catégorie</li>
