...
$lang=array(
    ...
    Si vous avez l'autorisation de modifier la session (propriétaire, gestionnaire, administrateur) et que l'exemplaire n'est pas provisoire, des boutons en bas à droite vous permettent de changer son état :
    <ul class='no_bullet'>
