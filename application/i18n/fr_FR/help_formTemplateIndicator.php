...
$lang=array(
    ...
    <ul>
    <li><b>Fixé par les enquêtuers ou les évaluateurs</b> : ce sont les enquêteurs (si le questionnaire est utilisé pour une enquête) ou les évaluateurs (si le questionnaire est utilisé pour une évaluation) qui définissent sa valeur</li>
    ...
    <ul>
    <li><b>fixé par les enquêteurs ou les évaluateurs</b> : la liste de ses valeurs potentielles sera définie à l'avance, et sa valeur définitive sera choisie par les enquêteurs (si le questionnaire est utilisé pour une enquête) ou les évaluateurs (s'il est utilisé pour une évaluation)</li>
