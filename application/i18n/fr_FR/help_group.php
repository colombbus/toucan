...
$lang=array(
    "showAll"=>"<h1>Liste des groupes</h1>
    Cette page présente la liste des groupes enregistrés dans Toucan.
    ",
    
    "show"=>"<h1>Affichage du détail d'un groupe</h1>
    <ul>
    <li><b>Groupe activé</b> : s'il est activé, le groupe est utilisable dans Toucan</li>
    <li class='help_separator'></li>
    <li><b>Nom du groupe</b> : le nom du groupe</li>
    <li><b>Description</b> : un texte descriptif optionnel</li>
    </ul>
    ",

    "members"=>"<h1>Affichage des membres du groupe</h1>
    <ul>
    ...
    "setMembers"=>"<h1>Définition des membres du groupe</h1>
    Cliquez sur un utilisateur pour l'affecter au groupe ou le désaffecter du groupe
    <ul>
    <li><b>Prénom</b> : le prénom de l'utilisateur</li>
    <li><b>Nom</b> : le nom de l'utilisateur</li>
    <li><b>Nom d'utilisateur</b> : le nom d'utilisateur utilisé dans Toucan</li>
    ...
    "edit"=>"<h1>Modification des informations du groupe</h1>
    <ul>
    <li><b>Nom du groupe</b> : le nom du groupe</li>
    <li><b>Description</b> : un texte descriptif optionnel</li>
    <li><b>Groupe activé</b> : cochez cette case si vous souhaitez que le groupe soit utilisé dans Toucan</li>
    </ul>
    ",

    "create"=>"<h1>Création d'un nouveau groupe</h1>
    <ul>
    <li><b>Nom du groupe</b> : le nom du groupe</li>
    <li><b>Description</b> : un texte descriptif optionnel</li>
    <li><b>Groupe activé</b> : cochez cette case si vous souhaitez que le groupe soit utilisé dans Toucan</li>
