...
$lang=array(
    ...
    <ul>
    <li><b>Fixé par les enquêteurs</b> : ce sont les enquêteurs qui définissent sa valeur au cours de l'enquête</li>
    ...
    <li><b>Type</b> : le type d'indicateur. Celui-ci peut être :
    <ul>
    <li><b>Fixé par les enquêteurs</b> : ce sont les enquêteurs qui définissent sa valeur au cours de l'enquêute</li>
    <li><b>Valeur numérique calculée automatiquement</b> : sa valeur se met à jour en fonction des questionnaires saisis</li>
    <li><b>Graphique calculé automatiquement</b> : sa représentation se met à jour en fonction des questionnaires saisis</li>
    </ul>
    </li>
    <li class='help_separator'></li>
    <li><b>Appliquer le même contrôle d'accès que pour l'enquête</b> : si la case est cochée, l'indicateur est consultable par tous les utilisateurs qui peuvent consulter l'enquête et est modifiable par tous ceux qui peuvent modifier l'enquête</li>
    <li><b>Visible par</b> : l'utilisateur ou l'ensemble des utilisateurs pouvant consulter cet indicateur</li>
    <li><b>Gestionnaires</b> : l'utilisateur ou l'ensemble des utilisateurs pouvant modifier cet indicateur</li>
    <li class='help_separator'></li>
    <li><b>Enquêteurs</b> (indicateur fixé manuellement) : l'utilisateur ou l'ensemble des utilisateurs pouvant définir la valeur de l'indicateur</li>
    </ul>
    ",
    ...
    <li><b>Variable</b> : la variable du questionnaire représentée sur le graphique. Vous pouvez choisir parmi la liste des variables du questionnaire de l'enquête.</li>
    ...
    Un indicateur automatique peut être calculé à partir d'un sous-ensemble des exemplaires du questionnaire. Ce sous-ensemble, appelé dans Toucan &laquo;&nbsp;sous-population&nbsp;&raquo;, est alors décrit par une liste de critères, reliés entre eux par un opérateur : ET ou OU.
    ...
    <ul>
    <li><b>fixé par les enquêteurs</b> : la liste de ses valeurs potentielles sera définie à l'avance, et sa valeur définitive sera choisie par les enquêteurs au cours de l'enquête</li>
    ...
    <li><b>Description</b> : un texte optionnel décrivant l'indicateur</li>
    <li class='help_separator'></li>
    <li><b>Appliquer le même contrôle d'accès que pour l'enquête</b> : si la case est cochée, la session est consultable par tous les utilisateurs qui peuvent consulter l'enquête et est modifiable par tous ceux qui peuvent modifier l'enquête</li>
    <li><b>Visible par</b> : l'utilisateur ou l'ensemble des utilisateurs pouvant consulter cet indicateur</li>
    <li><b>Gestionnaires</b> : l'utilisateur ou l'ensemble des utilisateurs pouvant modifier cet indicateur</li>
    <li class='help_separator'></li>
    <li><b>Evaluateurs</b> (indicateur fixé manuellement) : l'utilisateur ou l'ensemble des utilisateurs pouvant définir la valeur de l'indicateur</li>
