 ...
 *
 * $Id: Calendar.php,v 1.2 2010-08-11 17:46:54 benoit Exp $
 *
 * @package    Calendar
 * @author     Kohana Team
...
class Calendar_Core extends Event_Subject {
	...
	// Start the calendar on Moday by default
	...
	public static function days($length = TRUE)
	{
		...
		$lan=substr(url::current(),0,2);
		// Days of the week
		$days = array(Kohana::lang('calendar.sunday'), Kohana::lang('calendar.monday'), Kohana::lang('calendar.tuesday'), Kohana::lang('calendar.wednesday'), Kohana::lang('calendar.thursday'), Kohana::lang('calendar.friday'), Kohana::lang('calendar.saturday'));
		...
		}*/ //ne marche pas correctement, dépend de la version de Kohana. Modifierporu s'adapter au système de langues utilisé dans tous le système
	...
	public function add_data(array $data)
	{
		...
		if(! empty($data['event'])) $this->observed_data['event'][] = $data['event'];
	}
