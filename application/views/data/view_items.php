...
<?php
    ...
    echo "</ul>\n";
    /*if ($mayEdit&&isset($addItem)) {
        //$actions[] = array('type' => 'button','text' => $addItem,'js' => 'addItem()');
        echo form::button(array ('type'=>'button', 'name'=>"button_add"), Kohana::lang($addItem),"onClick=\"addItem()\" class=\"toucan_button\"");
    }*/
